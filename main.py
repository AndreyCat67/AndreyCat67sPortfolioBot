...
/skills - изпользуй для привязки навыков к проекту
/projects - изпользуй для отображения всех проектов
/delete - изпользуй для удаления проекта
/update_projects - изпользуй для изменения данных о проекте
